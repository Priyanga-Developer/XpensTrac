  ...
  return (
   <>
    ...
    paddingTop: "43px"}}>
          ...
          <Col xs={6} md={4} className='p-2'> {profilePhoto?<Image src={profilePhoto}roundedCircle  alt='profilepic'/>: <Avatar color={Avatar.getRandomColor('sitebase', ['red', 'yellow', 'blue'])} name={name}  size="100" round={true} />}</Col>
